...
var after = __webpack_require__(256);
var utf8 = __webpack_require__(257);

var base64encoder;
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(258);
}
...
var debug = __webpack_require__(245)('socket.io-parser');
...
var hasCORS = __webpack_require__(252);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_PropTypes__ = __webpack_require__(112);
...
var _reduxSocket = __webpack_require__(241);
...
// Redux
// React
console.log('ENV: ', _env.config.getEnv());
// Reducer

// Component

var socket = (0, _socket2.default)(_env.config.getEnv());
var socketIoMiddleware = (0, _reduxSocket2.default)(socket, "server/");

var store = (0, _redux.createStore)(_reducers2.default, (0, _redux.compose)((0, _redux.applyMiddleware)(_reduxThunk2.default, socketIoMiddleware)));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_PropTypes__ = __webpack_require__(112);
...
var _cal = __webpack_require__(231);
...
var _cal = __webpack_require__(232);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    return {
        increaseNum: function increaseNum() {
            dispatch((0, _socket.increase)());
        },
        decreaseNum: function decreaseNum() {
            dispatch((0, _socket.decrease)());
        }
    };
};

var CalContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_cal2.default);

exports.default = CalContainer;
...
var Cal = function (_React$Component) {
  ...
  function Cal() {
    ...
    return _possibleConstructorReturn(this, (Cal.__proto__ || Object.getPrototypeOf(Cal)).apply(this, arguments));
  }
  ...
  _createClass(Cal, [{
    ...
    value: function render() {
      var _props = this.props,
          increaseNum = _props.increaseNum,
          decreaseNum = _props.decreaseNum;

      return _react2.default.createElement(
        "div",
        null,
        _react2.default.createElement("input", { style: styles, className: "btn btn-default", defaultValue: "-",
...
var _restful = __webpack_require__(236);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mapStateToProps = function mapStateToProps(state, ownProps) {
    var num = state.counter.num;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    return {
        getCount: function getCount() {
            dispatch((0, _restful.getCount)());
        }
    };
};

var CounterContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_counter2.default);
...
var Counter = function (_React$Component) {
    ...
    _createClass(Counter, [{
        ...
        value: function componentDidMount() {
            var getCount = this.props.getCount;
...
var getCount = exports.getCount = function getCount() {
    return function (dispatch) {
        (0, _utils.getUrl)('/').then(function (response) {
            console.log('GET /: ', response);
            dispatch((0, _actions.update)(response.num));
        });
    };
};
...
var getUrl = exports.getUrl = function getUrl(path) {
    var url = _env.config.getEnv() + path;
    return fetch(url, {
        headers: {
...
var update = exports.update = function update(num) {
    return {
        type: 'client/UPDATE',
        num: num
    };
...
var RigMarket = (0, _redux.combineReducers)({
  counter: _counter2.default
});

exports.default = RigMarket;
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(108)(module), __webpack_require__(6)))
